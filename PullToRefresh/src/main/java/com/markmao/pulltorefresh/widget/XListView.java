...
//    private LinearLayout mHeaderContent;
    ...
    private void initWithContext(Context context) {
        ...
        // init header height
        mHeaderHeight = mHeader.getFixedHeight();
        toastTextView = (TextView) LinearLayout.inflate(getContext(), R.layout.view_textview, null);
    ...
    public void setPullRefreshEnable(boolean enable) {
        ...
        mHeader.setContentVisible(enable ? View.VISIBLE : View.INVISIBLE);
    }
...
//    }
    ...
    public void showToast(String msg) {
        ...
        toast.setGravity(Gravity.TOP | Gravity.FILL_HORIZONTAL, 0, position[1] - statusHeight);
